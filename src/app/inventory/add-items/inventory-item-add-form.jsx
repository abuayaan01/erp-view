...
export default function InventoryItemForm() {
    ...
    useEffect(() => {
        if (selectedItemGroup) {
            const filtered = items.filter((item) => item.itemGroupId === selectedItemGroup);
    ...
    const addItemToInventory = async () => {
        ...
        if (!selectedItem.id || !itemQuantity || Number.parseFloat(itemQuantity) <= 0) {
            toast({
                title: "Invalid Item",
        ...
        try {
            ...
            // console.log("Submitting entry:", inventoryItem);
        ...
        <div className="space-y-6">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Add a single inventory item with quantity</CardDescription>
                </CardHeader>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div className="space-y-2">
                            ...
                            >
                                <SelectTrigger>
                                    <SelectValue
                                        placeholder={selectedItemGroup ? "Select item" : "Select item group first"}
                                    />
                                </SelectTrigger>
                                <SelectContent>

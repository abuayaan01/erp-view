...
const generateDynamicSchema = (schema, categoryId, machineCategoryId) => {
  ...
  const config = categoryFieldConfigurations[machineCategoryId] || 
...
const Step1 = ({ onNext, primaryCategories, machineCategories, siteList, watch, currentConfig }) => {
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-12 gap-4">
        <div className="col-span-6">
          <Label htmlFor="machineName">Machine Name {currentConfig.machineName?.required ? "*" : ""}</Label>
          <Input
            id="machineName"
            {...onNext.register("machineName", { required: currentConfig.machineName?.required })}
          />
        ...
        <div className="col-span-6">
          <Label htmlFor="registrationNumber">Registration Number {currentConfig.registrationNumber?.required ? "*" : ""}</Label>
          <Input
            id="registrationNumber"
            {...onNext.register("registrationNumber", { required: currentConfig.registrationNumber?.required })}
          />
      ...
      <div className="grid grid-cols-12 gap-4">
        <div className="col-span-6">
          <Label htmlFor="machineNumber">Machine Number {currentConfig.machineNumber?.required ? "*" : ""}</Label>
          <Input
            id="machineNumber"
            {...onNext.register("machineNumber", { required: currentConfig.machineNumber?.required })}
          />
        ...
        <div className="col-span-6">
          <Label htmlFor="machineCode">Machine Code {currentConfig.machineCode?.required ? "*" : ""}</Label>
          <Input
            id="machineCode"
            {...onNext.register("machineCode", { required: currentConfig.machineCode?.required })}
          />
      ...
      <div className="grid grid-cols-12 gap-4">
        <div className="col-span-6">
          <Label htmlFor="erpCode">ERP Code {currentConfig.erpCode?.required ? "*" : ""}</Label>
          <Input
            id="erpCode"
            {...onNext.register("erpCode", { required: currentConfig.erpCode?.required })}
          />
...
const Step2 = ({ onNext, currentConfig }) => {
  return (
    <>
      <div className="grid grid-cols-12 gap-4">
        <div className="col-span-6">
          <Label htmlFor="chassisNumber">Chassis Number {currentConfig.chassisNumber?.required ? "*" : ""}</Label>
          <Input
            id="chassisNumber"
            {...onNext.register("chassisNumber", { required: currentConfig.chassisNumber?.required })}
          />
        ...
        <div className="col-span-6">
          <Label htmlFor="engineNumber">Engine Number {currentConfig.engineNumber?.required ? "*" : ""}</Label>
          <Input
            id="engineNumber"
            {...onNext.register("engineNumber", { required: currentConfig.engineNumber?.required })}
          />
      ...
      <div className="grid grid-cols-12 gap-4">
        <div className="col-span-6">
          <Label htmlFor="serialNumber">Serial Number {currentConfig.serialNumber?.required ? "*" : ""}</Label>
          <Input
            id="serialNumber"
            {...onNext.register("serialNumber", { required: currentConfig.serialNumber?.required })}
          />
        ...
        <div className="col-span-6">
          <Label htmlFor="model">Model {currentConfig.model?.required ? "*" : ""}</Label>
          <Input 
            id="model" 
            {...onNext.register("model", { required: currentConfig.model?.required })} 
          />
      ...
      <div className="grid grid-cols-12 gap-4">
        <div className="col-span-6">
          <Label htmlFor="make">Make {currentConfig.make?.required ? "*" : ""}</Label>
          <Input 
            id="make" 
            {...onNext.register("make", { required: currentConfig.make?.required })} 
          />
        ...
        <div className="col-span-6">
          <Label htmlFor="purchaseDate">Purchase Date {currentConfig.purchaseDate?.required ? "*" : ""}</Label>
          <Input
            id="purchaseDate"
            type="date"
            {...onNext.register("purchaseDate", { required: currentConfig.purchaseDate?.required })}
          />
      ...
      <div className="grid grid-cols-12 gap-4">
        <div className="col-span-6">
          <Label htmlFor="yom">Year of Manufacture {currentConfig.yom?.required ? "*" : ""}</Label>
          <Input
            id="yom"
            type="number"
            {...onNext.register("yom", { required: currentConfig.yom?.required })}
          />
        ...
        <div className="col-span-6">
          <Label htmlFor="capacity">Capacity {currentConfig.capacity?.required ? "*" : ""}</Label>
          <Input
            id="capacity"
            {...onNext.register("capacity", { required: currentConfig.capacity?.required })}
          />
...
const Step3 = ({ onNext, currentConfig }) => {
  return (
    <>
        ...
        <div className="grid grid-cols-12 gap-4">
          <div className="col-span-6">
            <Label htmlFor="fitnessCertificateExpiry">
              Fitness Certificate Expiry {currentConfig.fitnessCertificateExpiry?.required ? "*" : ""}
            </Label>
            <Input
              id="fitnessCertificateExpiry"
              type="date"
              {...onNext.register("fitnessCertificateExpiry", { required: currentConfig.fitnessCertificateExpiry?.required })}
            />
            <Input
          ...
          {currentConfig.motorVehicleTaxDue?.display !== false && (
            <div className="col-span-6">
              <Label htmlFor="motorVehicleTaxDue">Motor Vehicle Tax Due {currentConfig.motorVehicleTaxDue?.required ? "*" : ""}</Label>
              <Input
                id="motorVehicleTaxDue"
                type="date"
                {...onNext.register("motorVehicleTaxDue", { required: currentConfig.motorVehicleTaxDue?.required })}
              />
              <Input
      ...
      {currentConfig.permitExpiryDate?.display !== false && currentConfig.nationalPermitExpiry?.display !== false && (
        <div className="grid grid-cols-12 gap-4">
          {currentConfig.permitExpiryDate?.display !== false && (
            <div className="col-span-6">
              <Label htmlFor="permitExpiryDate">Permit Expiry Date {currentConfig.permitExpiryDate?.required ? "*" : ""}</Label>
              <Input
                id="permitExpiryDate"
                type="date"
                {...onNext.register("permitExpiryDate", { required: currentConfig.permitExpiryDate?.required })}
              />
              <Input
                id="permitFile"
                type="file"
          ...
          {currentConfig.nationalPermitExpiry?.display !== false && (
            <div className="col-span-6">
              <Label htmlFor="nationalPermitExpiry">National Permit Expiry {currentConfig.nationalPermitExpiry?.required ? "*" : ""}</Label>
              <Input
                id="nationalPermitExpiry"
                type="date"
                {...onNext.register("nationalPermitExpiry", { required: currentConfig.nationalPermitExpiry?.required })}
              />
              <Input
      ...
      {currentConfig.insuranceExpiry?.display !== false && currentConfig.pollutionCertificateExpiry?.display !== false && (
        <div className="grid grid-cols-12 gap-4">
          {currentConfig.insuranceExpiry?.display !== false && (
            <div className="col-span-6">
              <Label htmlFor="insuranceExpiry">Insurance Expiry {currentConfig.insuranceExpiry?.required ? "*" : ""}</Label>
              <Input
                id="insuranceExpiry"
                type="date"
                {...onNext.register("insuranceExpiry", { required: currentConfig.insuranceExpiry?.required })}
              />
              <Input
                id="insuranceFile"
                type="file"
          ...
          {currentConfig.pollutionCertificateExpiry?.display !== false && (
            <div className="col-span-6">
              <Label htmlFor="pollutionCertificateExpiry">
                Pollution Certificate Expiry {currentConfig.pollutionCertificateExpiry?.required ? "*" : ""}
              </Label>
              <Input
                id="pollutionCertificateExpiry"
                type="date"
                {...onNext.register("pollutionCertificateExpiry", {
                  required: currentConfig.pollutionCertificateExpiry?.required,
                })}
              />
              <Input
        ...
        <div className="grid grid-cols-12 gap-4">
          <div className="col-span-6">
            <Label htmlFor="machineImageFile">
              Machine Image {currentConfig.machineImageFile?.required ? "*" : ""}
            </Label>
            <Input
              id="machineImageFile"
              type="file"
              {...onNext.register("machineImageFile", { required: currentConfig.machineImageFile?.required })}
            />
            {onNext.formState.errors.machineImageFile && (
              <FormMessage>{onNext.formState.errors.machineImageFile.message}</FormMessage>
            )}
          </div>
        </div>
      )}
      ...
      {!currentConfig.fitnessCertificateExpiry?.display && 
       ...
       !currentConfig.machineImageFile?.display && (
        <div className="text-center py-8">
          <p className="text-gray-500">No document uploads required for this machine category.</p>
        </div>
      )}
    </>
  );
...
const Step4 = ({ onNext, currentConfig }) => {
  return (
    <>
      <div className="grid grid-cols-12 gap-4">
        <div className="col-span-6">
          <Label htmlFor="ownerName">Owner Name {currentConfig.ownerName?.required ? "*" : ""}</Label>
          <Input
            id="ownerName"
            {...onNext.register("ownerName", { required: currentConfig.ownerName?.required })}
          />
...
const AddMachineMultiStepForm = () => {
  ...
  const [fieldConfig, setFieldConfig] = useState(categoryFieldConfigurations.default);
  ...
  const { handleSubmit, watch, setValue, formState: { errors }, trigger, reset } = methods;
  ...
  useEffect(() => {
    if (machineCategoryId) {
      ...
      const newConfig = categoryFieldConfigurations[machineCategoryId] || 

...
export function LogbookDetails({ entry, onBack }) {
        ...
        <CardHeader>
          <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-2">
            <div>
              ...
              <CardDescription>Complete information for the selected logbook entry</CardDescription>
            </div>
            <div className="text-right">
              <div className="text-lg font-semibold">{format(new Date(entry.date), "PPP")}</div>
              <div className="text-sm text-muted-foreground">Entry #{entry.id}</div>
            </div>
          </div>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <div className="text-sm text-muted-foreground">Diesel Issue:</div>
                ...
                <div className="text-sm text-muted-foreground">Diesel Used:</div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="text-sm text-muted-foreground">KM Reading (Start):</div>
                <div>{entry.openingKMReading}</div>

                <div className="text-sm text-muted-foreground">KM Reading (End):</div>
                <div>{entry.closingKMReading}</div>

                <div className="text-sm text-muted-foreground">Total KM Run:</div>
                <div className="font-medium">{entry.totalRunKM}</div>

                <div className="text-sm text-muted-foreground">Diesel Efficiency:</div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="text-sm text-muted-foreground">Hours Meter (Start):</div>
                <div>{entry.openingHrsMeter}</div>

                <div className="text-sm text-muted-foreground">Hours Meter (End):</div>
                ...
                <div className="text-sm text-muted-foreground">Diesel per Hour:</div>
                <div className="font-medium">{entry.dieselAvgHrsMeter} L/Hr</div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-6 pt-6 border-t">
            ...
            <p className="text-muted-foreground">{entry.workingDetail || "No working details provided."}</p>
          </div>
        </CardContent>
      </Card>
    </div>

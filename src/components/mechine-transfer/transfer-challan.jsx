...
import TransferChallanPDF from "./TransferChallanPDF"
  ...
  return (
    <div className="space-y-4">
      {showPreview ? (
        ...
        <div className="border rounded-md p-6 space-y-6 bg-white max-w-[800px] mx-auto">
      ...
      <div className="flex justify-end gap-2">
        ...
        <PDFDownloadLink document={<TransferChallanPDF transfer={transfer} />} fileName={filename}>
          {({ loading }) => (
            <Button disabled={loading} onClick={handleDownloadSuccess}>
              <FileDown className="mr-2 h-4 w-4" />
              {loading ? "Generating PDF..." : "Download Challan"}
            </Button>
          )}
        </PDFDownloadLink>
      </div>
